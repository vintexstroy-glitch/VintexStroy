 ...
 *
 * Резен 110 чете два ИСТИНСКИ файла на собственика — линеен график от MS
 * Project и количествено-стойностна сметка. Те не влизат в хранилището:
 ...
 *
 * Пуска се с `node stroezh/mostri-pdf.mjs`; резултатът е два файла в
 * `tests/mostri/`. Не се вика от строежа: мострите се менят, когато се смени
 * форматът, и тогава разликата трябва да се ВИДИ в едно ревю.
 */
...
console.log('Мострите са написани: tests/mostri/lineen-grafik.pdf · tests/mostri/kss.pdf');
