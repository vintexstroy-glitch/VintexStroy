 ...
 * цели центове и ISO дати. Нищо не минава нататък неразчетено.
 *
 ...
 * приложена наобратно върху общата сума, да върне същите центове. Иначе
 * таблицата казва нещо, което не се връзва — и това е ред за човек, не за
 * закръгляне. Толерансът е един цент, защото източникът си закръглява сам.
 */
 ...
 * КАЗАНИ. Всичко останало е същото — цели центове, ISO дати, и ред, който не
