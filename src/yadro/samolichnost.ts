 ...
 *
 * ТРЕТОТО СЪСТОЯНИЕ Е СЪСТОЯНИЕ, НЕ ЛИПСА (правило 15 · резен Д).
 *
 * Дотук видовете бяха два, и при влизане се пишеше `'безплатно'` — ЗАКОВАНО,
 * никога питано, но сравнявано с плановете като ФАКТ. Подразбиране, преоблечено
 * като измерване, е по-лошо от липсващо число: то не пита за себе си.
 *
 * Затова докато Драйвът не е питан, тук стои `'не е питано'` — и екранът го
 * КАЗВА, вместо да твърди най-евтиното.
 */
export type VidHranilishte = 'безплатно' | 'платено' | 'не е питано';
