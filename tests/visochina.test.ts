 ...
 *
 * Трите готови гъстоти и лостът им бяха надживени от двете теми (резен 78 ·
 * ADR-135), а темите паднаха след тях с бутоните си (И127 т.3 · резен 92 ·
 * ADR-149). Остана ЕДНО подразбрано число и ВЛАЧЕНЕТО по ръба — то не е
 * бутон, а Ексел-жест, и той не го е назовал. Тук се проверява точно то:
 * границите на влаченето и двата дома на 26 (Гантът).
 */
