...
describe('пинът · числото се твърди с ръка (резен 46 · група В)', () => {
  it('първият свободен номер е СТО', () => {
    // Без този ред всяко сравнение отдолу е „изходът срещу същата константа":
    // сменена на 1, тя мести и двете страни и нищо не пада.
    expect(PARVI_SVOBODEN_NOMER).toBe(100);
  });
});
