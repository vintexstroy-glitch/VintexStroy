...
describe('честността на проверките', () => {
  it('обходите са ПЕТ · нов се добавя ТУК, за да не мине незабелязан', () => {
  ...
  it('а нечистените носят ХРАПОВ праг · днешното число, което може само да пада', () => {
    ...
    expect(pragovete().get('В · константа без нито един пин с ръка')).toBe(29);
  });
  ...
  it('днес минава · петте обхода са под праговете си', () => {
