...
describe('сверката на ДДС', () => {
  it('всичко се покрива → сверено, и разликата се записва като НУЛА', () => {
    ...
    const r = sveriDDS({
      ...
      dds_ot_fakturi_st: stotinki(250_00),
      dds_ot_izvlecheniya_st: stotinki(250_00),
      dds_vneseno_st: stotinki(250_00),
    });
  ...
  it('пари в банката БЕЗ фактура — точно случаят, който той описа', () => {
    const r = sveriDDS({
      ...
      dds_ot_fakturi_st: stotinki(200_00),
      dds_ot_izvlecheniya_st: stotinki(283_33),
      dds_vneseno_st: stotinki(200_00),
    });
  ...
  it('фактура БЕЗ движение — плащане в брой или неполучено', () => {
    const r = sveriDDS({
      ...
      dds_ot_fakturi_st: stotinki(266_67),
      dds_ot_izvlecheniya_st: stotinki(200_00),
      dds_vneseno_st: stotinki(266_67),
    });
    expect(r.nesvarsheni).toHaveLength(1);
  ...
  it('движение без номер на документ НЕ се преглъща', () => {
    ...
    const r = sveriDDS({
      ...
      dds_ot_fakturi_st: stotinki(0),
      dds_ot_izvlecheniya_st: stotinki(83_33),
      dds_vneseno_st: stotinki(0),
    });
    expect(r.nesvarsheni).toHaveLength(1);
    expect(r.nesvarsheni[0]!.prichina).toBe('lipsva-faktura');
  });
  ...
  it('сдвоява по документ, не по сума — две фактури за еднакво в един ден', () => {
    const r = sveriDDS({
      ...
      dds_ot_fakturi_st: stotinki(400_00),
      dds_ot_izvlecheniya_st: stotinki(400_00),
      dds_vneseno_st: stotinki(400_00),
    });
    expect(r.svereno).toBe(true);
  });
  ...
  it('разстояния и регистър в номера не правят втори документ', () => {
    const r = sveriDDS({
      ...
      dds_ot_fakturi_st: stotinki(16_67),
      dds_ot_izvlecheniya_st: stotinki(16_67),
      dds_vneseno_st: stotinki(16_67),
    });
    expect(r.svereno).toBe(true);
  });
  ...
  it('остава за внасяне · когато е платено по-малко от дължимото', () => {
    const r = sveriDDS({
      ...
      dds_ot_fakturi_st: stotinki(200_00),
      dds_ot_izvlecheniya_st: stotinki(200_00),
      dds_vneseno_st: stotinki(150_00),
    });
  ...
  it('надвнесено се вижда като отрицателно, не се крие', () => {
    const r = sveriDDS({
      ...
      dds_ot_fakturi_st: stotinki(200_00),
      dds_ot_izvlecheniya_st: stotinki(200_00),
      dds_vneseno_st: stotinki(260_00),
    });
