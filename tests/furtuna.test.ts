      ...
      if (zar < 0.15 || imoti.length === 0) {
        ...
        await deystviya.dobaviNaem(
          id,
          {
            ...
            naem_st: tsentove(100 + izbroy(500_000)),
            padezhDen: 1 + izbroy(31),
            ot: '2025-01-01',
            do: '',
            depozit_st: tsentove(izbroy(200_000)),
        ...
        await deystviya.nachisliVzemane(
          id,
          {
            ...
            osnovanie: 'наем',
            suma_st: tsentove(100 + izbroy(500_000)),
            padezh: '2026-06-15',
          },
        ...
        await deystviya.priemiPlashtane(
          id,
          {
            ...
            suma_st: tsentove(1 + izbroy(600_000)),
 ...
 * за НУЛА влизаше през Вратата (правило 3 иска цели центове — нулата е цяла) и
 ...
 *   2. ЗАТВАРЯ · дебит = кредит, до цент, за всеки период поотделно.
 */
 ...
 *   3. ГЛАВНАТА КНИГА НЕ ХВЪРЛЯ И ЗАТВАРЯ. Дебит = кредит, до цент — при
