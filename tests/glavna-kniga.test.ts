 ...
 * при 9% и при нечетни суми статията се разминава с една стотинка и файлът
...
describe('равенството на страните · онова, което прави статията счетоводна', () => {
  ...
  it('отрицателен ред ХВЪРЛЯ · знакът се носи от СТРАНАТА', () => {
    ...
    ).toThrow(/цели стотинки над нулата/);
  });
});
 ...
 * една стотинка. Тук се минава през всяка ставка и през суми, избрани точно
 * да падат между стотинките.
 */
describe('стотинката · всяка ставка, всяка неудобна сума', () => {
