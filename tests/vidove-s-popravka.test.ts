 ...
 * Шестте обещания:
 *
 *   1. Списъкът е ШЕСТ и се БРОИ, не се чете на око.
...
describe('списъкът се БРОИ, не се чете на око', () => {
  it('е СЕДЕМ, и точно тези', () => {
    // Седмият дойде с резен 79: клетката на добавена колона се създава и се
    // поправя с ЕДНО събитие върху адреса „таблица · ред · колона".
    expect(VIDOVE_S_POPRAVKA_NA_MYASTO).toHaveLength(7);
