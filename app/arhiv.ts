...
export function arhivZaEksel(sabitiya: readonly Sabitie[], o: Ogledalo, kogato: string): Uint8Array {
  ...
  const vzemaniya: List = {
    ...
    koloni: [
      ...
      { ime: 'Начислено, лв.', shirina: 14 },
      { ime: 'Погасено, лв.', shirina: 14 },
      { ime: 'Остатък, лв.', shirina: 13 },
  ...
  const dds: List = {
    ...
    koloni: [
      { ime: 'Период', shirina: 10 },
      { ime: 'Приход, лв.', shirina: 12 },
      { ime: 'Разход, лв.', shirina: 12 },
      { ime: 'ДДС изход, лв.', shirina: 14 },
      { ime: 'ДДС вход, лв.', shirina: 13 },
      { ime: 'За внасяне, лв.', shirina: 14 },
      { ime: 'Декларирано, лв.', shirina: 15 },
      { ime: 'Платено, лв.', shirina: 12 },
