  ...
  return `
    <section class="karta" data-sektsiya="koy-sam">
      ...
      <p class="drebno" data-pole="granitsa-na-knigata">
        ...
        своя. Две книги не се сливат от само себе си: <b>книгата на работодателя
        се отваря от споделената папка при доставчика</b>, и точно това още не е
        построено. Дотогава записаният служител вижда своя Журнал, а не твоя —
        казано тук, за да не се работи седмици в грешната книга.
      </p>
      <div class="deystviya">
