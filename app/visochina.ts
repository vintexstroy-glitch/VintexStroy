 ...
 *
 * Дотук темите на натоварването я предефинираха от корена; те паднаха с
 * бутоните си (И127 т.3 · ADR-149) и числото ОСТАНА — то е онова, което
 * екранът е показвал. Влаченето по ръба продължава да го бие за своята
 * таблица: по-тясното решение бие по-широкото.
 */
